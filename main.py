...
class AdminApp(QMainWindow):
    def __init__(self):
        ...
        self.comboBox_1.currentIndexChanged.connect(self.messageSelected)
...
###############################################################################################################
    ...
    def load_users(self):
        try:
            with open('users.json', 'r') as file:
                ...
                for user in users:
                    self.comboBox_1.addItem(user['email'])
        except FileNotFoundError:
    ...
    def send_message(self):
        selected_email = self.comboBox_1.currentText()
        sender = self.email
        message_text = self.LineEdit_1.text()
    ...
    def messageSelected(self):
        ...
        message_receiver = self.comboBox_1.currentText()
...
#################################################################################################################
    ...
    def send_message(self):
        selected_email = self.comboBox_3.currentText()
        sender = self.email
